...
rm ~/BindassBoost_a110/mtktools/BBFZ/system/lib/modules/zram.ko
rm ~/BindassBoost_a110/mtktools/BBFZ/system/lib/modules/m4u.ko
rm ~/BindassBoost_a110/mtktools/BBFZ/boot.img
rm ~/BindassBoost_a110/mtktools/zimage
rm ~/BindassBoost_a110/out/BindassBoost_v.zip
